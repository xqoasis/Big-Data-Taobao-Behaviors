create table airport_delays_by_year (
  airport string, year int, flights int,
...
insert overwrite table airport_delays_by_year
  select origin_name, year, count(1),
